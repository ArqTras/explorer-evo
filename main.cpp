...
main(int ac, const char* av[])
{
    ...
    // set Evolution log output level
    ...
    if (testnet && deamon_url == "http://127.0.0.1:42462")
        deamon_url = "http://127.0.0.1:29994";
    if (stagenet && deamon_url == "http://127.0.0.1:42462")
